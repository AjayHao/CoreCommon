    ...
    private static boolean inYear(Date date, int expect, RoundingMode mode) {
        ...
        switch (expect) {
            ...
            case -2: // 年中；
                ...
                return decimal.setScale(0, mode.ordinal()).intValue() == curr;
            default:
                return expect == curr;
        }
    }
    ...
    private static boolean inQuarter(Date date, int expect, RoundingMode mode) {
        ...
        switch (expect) {
            ...
            case -2: // 季中；
                ...
                final int mid = decimal.setScale(0, mode.ordinal()).intValue();
...
//============================4.时间加减=====================================    
    ...
    public static int days(Date startDate, Date endDate) {
        if (endDate == null || startDate == null) {
            throw new BaseException(BizCode.INVALID_PARAM, "参数不能为null");
        }
